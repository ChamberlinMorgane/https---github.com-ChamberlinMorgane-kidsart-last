<template>
  <div class="h-96 bg-fond1footer p-3">
    <div>
    ...
    <div class="mx-7 flex gap-6">
      ...
      <div>
        <a href="https://www.linkedin.com/in/marion-gillot-8133a7224/" aria-label="Instagram">
          <img src="/icons/instagram.svg" alt="icons instagram"
        /></a>
      </div>
      <div>
        <a href="https://twitter.com/1820Tc" aria-label="Twitter"> <img src="/icons/twitter.svg" alt="icons twitter" /></a>
      </div>
      <div class="w-6">
    ...
    <p class="mt-10 text-center">©Sunset</p>
  </div>
</template>