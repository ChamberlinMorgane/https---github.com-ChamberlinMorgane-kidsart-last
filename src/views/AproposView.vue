<template>
  ...
  <p class="m-auto mr-20 mt-10 flex justify-center text-center lg:text-xl">
  ...
  <p class="m-auto mt-10 flex justify-center text-center lg:text-xl">
    Nous demandons aux utilisateurs de signaler toute personne qui utilise un language ou des images blessantes ou inapropriés (commentaire,
    message, noms d'utilisateurs, avatars, créations.)
  </p>
  <p class="m-auto mt-10 mb-11 flex justify-center text-center lg:text-xl">
    Votre enfant devrait égaleemnt utiliser des filtres de language pour l'empêcher d'afficher tout contenu qui pourrait venir d'autres
    utilisateurs
  </p>
</template>