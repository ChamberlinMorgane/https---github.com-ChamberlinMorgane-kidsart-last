  ...
  <main>
    ...
    <div class="grid grid-cols-1 justify-items-center lg:grid-cols-2">
      <div>
        ...
        <p class="m-auto mt-9 flex justify-center font-acme lg:text-xl">Morgane CHAMBERLIN</p>
      </div>
      <div>
        <img src="/images/image-avatar-marion.jpg" alt="image bonhomme marion" />
        <p class="m-auto mt-9 flex justify-center font-acme lg:text-xl">Marion GILLOT</p>
      </div>
    </div>

    <p class="ml-96 mr-96 mt-20 mb-20 flex justify-center text-center lg:text-xl">
    ...
    <p class="ml-52 mr-52 mt-5 flex justify-center lg:text-xl">
      - Nous demandons aux utilisateurs de signaler toute personne qui utilise un language ou des images blessantes ou inapropriés
      (commentaire, message, noms d'utilisateurs, avatars, créations.)
    </p>
    <p class="ml-52 mr-52 mb-52 flex justify-center lg:text-xl">
      - Votre enfant devrait également utiliser des filtres de language pour l'empêcher d'afficher tout contenu qui pourrait venir d'autres
      utilisateurs
    </p>
  </main>
</template>